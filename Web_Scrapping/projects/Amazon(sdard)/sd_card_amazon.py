# -------------------Scrapping the sdcard data from amazon website----------------------------------------------------
...
# function for scrape the data and putting into the  list of dictionary
dealslist = []
def getdeals(soup):
...
df.to_csv('sdcard_amazon.csv', index = False)